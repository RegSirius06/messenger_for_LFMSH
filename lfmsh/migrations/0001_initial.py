# Generated by Django 4.2.2 on 2023-08-03 05:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_theme', models.CharField(choices=[('c', 'Компьютерный'), ('f', 'Телефонный')], default=0, max_length=1, verbose_name='Тип темы:')),
                ('postfix', models.CharField(default='', help_text='Постфикс - это то, что будет приписано в конец css тэга. Писать только латиницей.\nПример: тэг "pass". Тогда к css при генерации таблицы будет обращён запрос "table_pass".', max_length=15, verbose_name='Постфикс:')),
            ],
            options={
